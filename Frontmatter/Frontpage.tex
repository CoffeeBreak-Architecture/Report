...
\TitleFont{A spacially aware virtual communication} \\
\TitleFont{breakroom} \bigskip \\ 
...
\node[anchor=north west, 
     ...
     {\includegraphics[width=50mm,keepaspectratio]{Pictures/Logos/sdu_white_cmyk.eps}}; 
\end{tikzpicture}
...
\node[anchor=south, % anchor is bottom of picture
     ...
     {\includegraphics[height=18.9cm,keepaspectratio]{Pictures/Placeholder/FrontpagePlaceholder.png}};
\end{tikzpicture}
